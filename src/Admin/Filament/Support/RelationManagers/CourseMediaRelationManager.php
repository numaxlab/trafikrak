...
class CourseMediaRelationManager extends MediaRelationManager
{
    ...
    public function getDefaultTable(Table $table): Table
    {
        return $table
            ...
            ->modifyQueryUsing(fn (Builder $query) => $query->where('collection_name',
                $this->mediaCollection)->orderBy('order_column'))
            ->columns([
            ...
            ->headerActions([
                Tables\Actions\CreateAction::make()
                    ...
                    ->using(function (array $data, string $model): Model {
                        return $this
                            ->getOwnerRecord()->addMediaFromString($data['media']->get())
                            ->usingFileName(
                            ...
                            ->withCustomProperties([
                                ...
                                'orientation' => $data['custom_properties']['orientation'],
                            ])
                            ->preservingOriginal()
                            ->toMediaCollection($this->mediaCollection);
                    })->after(
                        fn () => ModelMediaUpdated::dispatch($this->getOwnerRecord()),
                    ),
            ])
            ->actions([
